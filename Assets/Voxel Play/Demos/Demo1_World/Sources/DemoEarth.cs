...
namespace VoxelPlayDemos {
    ...
    public class DemoEarth : MonoBehaviour {
        ...
        void OnInitialized() {
            ...
            VoxelPlayPlayer.instance.AddInventoryItem(env.GetItemDefinition("Pickaxe"));

            // Add a mace (which enables microvoxels of size 3)
            VoxelPlayPlayer.instance.AddInventoryItem(env.GetItemDefinition("Mace"));

            // Add a shotgun (which enables microvoxels of size 6 and random probability)
            VoxelPlayPlayer.instance.AddInventoryItem(env.GetItemDefinition("Shotgun"));

            // Add 20 grenades
            VoxelPlayPlayer.instance.AddInventoryItem(env.GetItemDefinition("Grenade"), 20);
        ...
        /// <summary>
        /// 복셀 환경과 상호작용하는 공을 소환합니다.콘솔에 "Invoke Demo Ball"을 입력하여 실행할 수 있습니다.
        /// </summary>
        void ThrowBall() {
        ...
        /// <summary>
        /// 플레이어 앞에 brickWall 복셀을 배치합니다.콘솔 "Invoke Demo PlaceBrick"에 진입한 게임에서 실행 가능
        /// </summary>
        void PlaceBrick() {
