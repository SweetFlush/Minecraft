...
namespace VoxelPlay {
    ...
    public partial class VoxelPlayEnvironment : MonoBehaviour {
        ...
        /// 입자 재질을 설정합니다.
        /// </summary>
        /// <param name="isDamageParticle">true인 경우 textSample 속성을 존중합니다.</param>
        ...
        void AddParticlesAtHitPoint (int particlesAmount, Vector3 camForward, bool destroyed, VoxelHitInfo hitInfo, int voxelLight, float initialParticleDistance = 1f) {
