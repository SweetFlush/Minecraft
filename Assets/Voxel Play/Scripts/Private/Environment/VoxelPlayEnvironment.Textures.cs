...
namespace VoxelPlay {
    ...
    public partial class VoxelPlayEnvironment : MonoBehaviour {
        ...
        /// <summary>
        /// 이름으로 복셀 정의에 대한 사전 조회
        /// </summary>
        Dictionary<string, VoxelDefinition> voxelDefinitionsDict;

        /// <summary>
        /// 텍스처 배열을 다시 생성해야 하는 경우(즉, 새 복셀 정의가 추가된 경우) true로 설정합니다.
        /// </summary>
        bool requireTextureArrayUpdate;

        /// <summary>
        /// 런타임 시 사용자가 추가한 임시/세션 복셀
        /// </summary>
        ...
        void InitRenderingMaterials() {
            ...
            if (mainTextureProvider == null) {
                TextureProviderSettings settings = TextureProviderSettings.Create(textureSize, textureScale: 1f, enableNormalMap, enableReliefMapping, this);
        ...
        /// <summary>
        /// 배열에 복셀 정의를 추가합니다.인덱스 할당을 제외하고 안전 확인을 수행하거나 복셀 정의를 수정하지 않습니다.
        /// </summary>
        ...
        /// <summary>
        /// 사용자 복셀 정의를 배열에 삽입합니다.인덱스 할당을 제외하고 안전 확인을 수행하거나 복셀 정의를 수정하지 않습니다.
        /// </summary>
