...
namespace VoxelPlay {
    ...
    public struct VoxelHitInfo {
        ...
        /// <summary>
        /// 적중 위치까지의 거리(거리*거리)를 제곱한 것입니다.
        /// </summary>
        public float sqrDistance;

        /// <summary>
        /// Chunk.voxels 배열에서 적중되는 복셀의 인덱스
        /// </summary>
        ...
        /// <summary>
        /// 복셀 히트의 복사본입니다.RayCast가 완료된 후 위치가 지워지더라도 이 복사본은 변경되지 않습니다.지금 이 위치의 복셀을 얻으려면 GetVoxelNow()를 호출하세요.
        /// </summary>
        /// <value>복셀.</value>
        public Voxel voxel;
        ...
        /// <summary>
        /// 복셀 히트에 자리 표시자가 첨부된 경우 이에 대한 참조가 여기에 반환됩니다.
        /// </summary>
    ...
    public partial class VoxelPlayEnvironment : MonoBehaviour {
        ...
        /// 복셀 손상을 수행합니다.
        /// </summary>
        /// <returns>복스가 실제로 받는 피해입니다.</returns>
