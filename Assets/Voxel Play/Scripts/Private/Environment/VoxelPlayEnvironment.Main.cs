...
namespace VoxelPlay {
    ...
    public partial class VoxelPlayEnvironment : MonoBehaviour {
        ...
        /// <summary>
        /// 월드 공간의 currentAnchorPos(원점 이동이 비활성화된 경우 currentAnchorPos와 동일)
        /// </summary>
        ...
        /// <summary>
        /// Voxel Play로 생성된 모든 객체가 배치되는 월드 루트의 변환
        /// </summary>
        [NonSerialized]
        public Transform worldRoot;

        /// <summary>
        /// ShowMessage() 메소드로 보낸 마지막 메시지를 저장합니다.
        /// </summary>
        [NonSerialized]
        ...
        /// <summary>
        /// 루프에서 청크의 여러 수정 사항을 태그하고 그룹화하는 데 사용됩니다.
        /// </summary>
        int modificationTag;
        ...
        /// <summary>
        /// true인 경우 Voxel Play는 내보낸 청크에 사용할 수 있도록 텍스처 배열을 해제하지 않습니다.
        /// </summary>
        [NonSerialized]
        public bool keepTexturesOnDestroy;

        /// <summary>
        /// 엔진을 초기화하고 saveGameFile 속성에 지정된 저장 게임을 로드합니다.
        /// </summary>
        ...
        /// <summary>
        /// 엔진을 초기화합니다.선택적으로 초기화가 끝나면 콜백 함수를 호출합니다.
        /// </summary>
        /// <param name="callback">초기화가 끝나면 호출될 콜백 함수입니다.</param>
        ...
        void DoWorkOnce (long maxCPUTimePerFrame, bool force = false) {
            ...
            try {
                ...
                if (!applicationIsPlaying) {
                    if (renderInEditorLowPriority && !force) {
                        if (cameraHasMoved) {
        ...
        /// <summary>
        /// 렌더러가 사용하는 현재 카메라를 반환합니다.재생 모드가 아닌 편집기 모드에서는 SceneView 카메라입니다.
        /// </summary>
        /// <value>현재 카메라입니다.</value>
        ...
        void CheckSpecialFeaturesScriptingSupport () {
            ...
            if (supportsURP != isURPActive || Voxel.supportsTinting != enableTinting || supportsSeeThrough != seeThrough || supportsBrightPointLights != enableBrightPointLights || supportsFresnel != enableFresnel || supportsURPNativeLights != enableURPNativeLights || supportsGlobalSpecular != enableGlobalSpecular) {
