...
namespace VoxelPlay {
    ...
    public partial class VoxelPlayEnvironment : MonoBehaviour {
        ...
        /// <summary>
        /// 월드 레벨에서 정의된 항목과 모든 지형 복셀을 사용하여 사용 가능한 항목 "allItems"의 배열을 초기화합니다.
        /// </summary>
        void InitItems() {
        ...
        /// 항목 정의를 추가합니다.
        /// </summary>
        /// <returns><c>진실</c>, if item definition was added, <c>거짓</c> otherwise.</returns>
