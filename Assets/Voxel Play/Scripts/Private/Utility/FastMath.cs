...
namespace VoxelPlay {
	...
	public static class FastMath {
		...
		[MethodImpl(256)]
		public static Vector2Int FloorToInt (double x, double z) {
#if UNITY_IOS || UNITY_ANDROID || UNITY_WEBGL
			int ix = (int)x;
			if (ix>x) ix--;
			int iz = (int)z;
...
#else
			return new Vector2Int((int)(x + 1000000d) - 1000000, (int)(z + 1000000d) - 1000000);
#endif
		}


		[MethodImpl(256)]
		public static void FloorToInt (double x, double z, out int ix, out int iz) {
#if UNITY_IOS || UNITY_ANDROID || UNITY_WEBGL
			ix = (int)x;
			if (ix>x) ix--;
			iz = (int)z;
